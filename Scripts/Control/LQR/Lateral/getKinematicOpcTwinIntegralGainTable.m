%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Offline Lateral Kinematic Twin Integral Optimal Preview Controller %%%%%%
% Version: v1.0 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Date: 2023/03/09 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Author: Li.Ang %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%**** Calculate Matrix Ac, Bc & Gc ***************************************%
    Matrix_Ac_4ws(1,2) = +1;
    Matrix_Ac_4ws(2,3) = +1;
    Matrix_Ac_4ws(3,6) = +Vx;
    Matrix_Ac_4ws(4,5) = +1;
    Matrix_Ac_4ws(5,6) = +1;
    Matrix_Bc_4ws(3,1) = +(Vx*Lr)/(Lf+Lr);
    Matrix_Bc_4ws(3,2) = +(Vx*Lf)/(Lf+Lr);
    Matrix_Bc_4ws(6,1) = +Vx*Lf;
    Matrix_Bc_4ws(6,2) = -Vx*Lr;
    Matrix_Gc_4ws(6,1) = -Vx;
